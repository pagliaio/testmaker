...
fitb_entry.grid(row=4, column=0, padx=5, pady=5, sticky='ew')
...
reading_test_label.grid(row=5, column=0, padx=5, pady=5, sticky='ew')
reading_test_entry = tk.Text(exercise_frame, height=10, width=30, bg='orange')
reading_test_entry.grid(row=6, column=0, padx=5, pady=5, sticky='ew')

# Multiple choice answers OR matching exercise
multiple_choice_answers_label = tk.Label (exercise_frame, text='Multiple choice answers / Matching words:', width=30, height=1, anchor="center", bg='lawngreen')
...
CreateToolTip(multiple_choice_answers_label, text = 'Write here the possible answers for Multiple Choice or Matching Words exercises.\n'
              'In any case, follow this format (options separated by commas, one set per line):\n'
...
multiple_choice_options_label = tk.Label (exercise_frame, text='Multiple choice / Matching words:', width=30, height=1, anchor="center", bg='lawngreen')
multiple_choice_options_label.grid(row=3, column=1, padx=5, pady=5, sticky='ew')
